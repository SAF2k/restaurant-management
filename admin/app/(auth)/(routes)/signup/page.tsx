      ...
      <div className="flex items-center justify-center isolate px-6 pt-[10%] lg:px-8">
        ...
        <Form {...form}>
          <form
            ...
            className="space-y-4 bg-slate-900 p-14 shadow shadow-popover rounded-lg text-white"
          >
            <h1 className="text-primary text-2xl sm:text-3xl text-center my-2 bg-slate-500 rounded-md py-2">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-white">Store ID</FormLabel>
                  <FormControl>
                    <Input
                      className="text-black"
